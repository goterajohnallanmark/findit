...
@section('title', ($item->title ?? 'Found Item') . ' - FindIt')
...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 mb-4">
            <a href="{{ route('found-items.index') }}" class="btn btn-link text-decoration-none px-0">
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                <div class="position-relative">
                    <img src="{{ $item->image_url ?? 'https://via.placeholder.com/800x400?text=Found+Item' }}" 
                         class="card-img-top" 
                         alt="{{ $item->title }}"
                         style="max-height: 400px; object-fit: cover;">
                    <span class="badge bg-success position-absolute top-0 end-0 m-3 fs-6">
                        <i class="bi bi-box-seam me-1"></i> Found Item
                    </span>
                </div>
            </div>
                        ...
                        @auth
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('found-items.edit', $item->id) }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <small class="text-muted d-block">Found Location</small>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <strong>{{ $item->found_date?->format('M d, Y') }}</strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted mb-4">If this is your lost item, you can claim it and arrange to get it back.</p>
                    <button type="button" class="btn btn-success w-100 mb-2" data-bs-toggle="modal" data-bs-target="#claimModal">
                        <i class="bi bi-hand-thumbs-up me-2"></i> This Is Mine
                    </button>
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <ul class="mb-0 text-muted small">
                        ...
                        <li class="mb-2">Verify identity before claiming items</li>
                        <li class="mb-2">Provide proof of ownership</li>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="text-muted mb-0">This action cannot be undone. Are you sure you want to delete this found item?</p>
            </div>
