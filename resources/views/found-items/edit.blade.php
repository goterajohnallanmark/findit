...
@section('title', 'Edit Found Item - FindIt')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <!-- Back Button -->
            <a href="{{ route('found-items.show', $item->id ?? '#') }}" class="btn btn-link text-decoration-none mb-4 px-0">
            ...
            <div class="mb-4">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h1 class="page-title mb-1">Edit Found Item</h1>
                        <p class="page-subtitle mb-0">Update the details of your found item</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body p-4 p-lg-5">
                    <form action="{{ route('found-items.update', $item->id ?? '#') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="found_date" class="form-label">Found Date <span class="text-danger">*</span></label>
                            <input type="date" 
                        ...
                        <div class="d-flex gap-3 mt-5 pt-4 border-top">
                            ...
                            <a href="{{ route('found-items.show', $item->id ?? '#') }}" class="btn btn-secondary btn-lg">
                                Cancel
                            </a>
                        </div>
                    </form>
